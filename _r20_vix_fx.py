#!/usr/bin/env python3
"""R20: V39 VIX + V40 USD/TWD new data source filters"""
...
COMBOS = {
    ...
    # V39: VIX filter
    'vix_25_30':    {'enable_vix_filter': True, 'vix_caution_threshold': 25, 'vix_block_threshold': 30,
                     'vix_caution_max_buy': 2},
    'vix_20_28':    {'enable_vix_filter': True, 'vix_caution_threshold': 20, 'vix_block_threshold': 28,
                     'vix_caution_max_buy': 2},
    'vix_25_35':    {'enable_vix_filter': True, 'vix_caution_threshold': 25, 'vix_block_threshold': 35,
                     'vix_caution_max_buy': 2},
    'vix_30_40':    {'enable_vix_filter': True, 'vix_caution_threshold': 30, 'vix_block_threshold': 40,
                     'vix_caution_max_buy': 2},

    # V40: FX depreciation filter
    'fx_2':         {'enable_fx_filter': True, 'fx_depreciation_pct': 2.0, 'fx_caution_max_buy': 2},
    'fx_3':         {'enable_fx_filter': True, 'fx_depreciation_pct': 3.0, 'fx_caution_max_buy': 2},
    'fx_1.5':       {'enable_fx_filter': True, 'fx_depreciation_pct': 1.5, 'fx_caution_max_buy': 1},

    # Combos
    'vix25_fx2':    {'enable_vix_filter': True, 'vix_caution_threshold': 25, 'vix_block_threshold': 30,
                     'vix_caution_max_buy': 2,
                     'enable_fx_filter': True, 'fx_depreciation_pct': 2.0, 'fx_caution_max_buy': 2},
    'vix30_fx3':    {'enable_vix_filter': True, 'vix_caution_threshold': 30, 'vix_block_threshold': 40,
                     'vix_caution_max_buy': 2,
                     'enable_fx_filter': True, 'fx_depreciation_pct': 3.0, 'fx_caution_max_buy': 2},
}
...
print('=' * 130)
print('  R20: V39 VIX + V40 USD/TWD filters')
